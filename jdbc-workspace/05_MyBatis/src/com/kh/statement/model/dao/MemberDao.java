...
public class MemberDao {
	...
	public int save(SqlSession session , Member member) {
		...
		//int result = session.insert("mamberMapper.save", member);
	...
	public List<Member> findAll(SqlSession session){
		...
		//session.selectList("memberMapper.findAll");
	...
	public int update(SqlSession session ,PassWordDTO pdto) {
		
		return session.update("memberMapper.update",pdto);
