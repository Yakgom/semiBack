...
public class VendingView {
    ...
    private void update() {
    	...
    	System.out.print("바꾸실 음료수의 이름을 적어주세요 > ");
    	String drinkName = sc.nextLine();
    	System.out.print("수정할 재고량을 적어주세요 > ");
    	int changeStock = sc.nextInt();
    	sc.nextLine();
    	
    	int result = vc.update(drinkName,changeStock);
    	
    	if(result > 0) {
    		System.out.println("재고 변경에 성공했습니다.");
    	}
    	else {
    ...
    private void delete() {
    	...
    	System.out.print("음료수의 이름을 입력해주세요 > ");
    	String drinkName = sc.nextLine();
    	System.out.print("음료수 제조사를 입력해주세요 > ");
    	String vendor = sc.nextLine();
    	
    	
    	int result = vc.delete(drinkName , vendor);
