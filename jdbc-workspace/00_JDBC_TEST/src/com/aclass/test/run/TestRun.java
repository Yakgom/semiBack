...
public class TestRun {
	...
	public static void main(String[] args)  {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("무조건 63행이문제");
		} catch (SQLException e) {
			e.printStackTrace();
			System.out.println("사용자명/비밀번호가 부적합> 아이디 비번 잘못 입력");
			System.out.println("부적합한 Oracle URL이 지정 > URL 잘못 입력");
			System.out.println("SQLSyntexErrorException > SQL문 확인");
			System.out.println("NullPointerException > JDBC 객체들 확인하기");
		} finally {
