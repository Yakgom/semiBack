 ...
 * [ 표현법 ]
 * 
 * 1) INSERT INTO 테이블명 VALUES(값,값,값,값,값,...........);
 * 
 * => 해당 테이블에 모든 컬럼에 추가하고자 하는 값을 직접 입력해서 한 행을 INSERT할 떄 사용
 * 
 ...
 * INSERT는 무조건 한 행 단위로 추가가 되기 떄문에 작성하지 않은 컬럼은 NULL값이 들어감
 * 
 * 
 * 주의할 점 ) NOT NULL이 달려있는 컬럼은 반드시 테이블 명 뒤에 컬럼명을 적어야한다
