...
<body>
	...
	<p>
	 ...
	 수강생의 정보
	 <ul>
	 <li>이름 : <%=student.getName() %></li><br>
	 <li>이름 : <%=student.getAge() %></li><br>
	 <li>이름 : <%=student.getAddress() %></li><br>
	 </ul>
