...
<body>
	...
	<p>
		Jakarta Server Page Standard Tag Library JSP에서 사용할 수 있는 커스텀 액션 태그 <br>
		공통적으로 사용해야하는 코드들의 집합을 보다 쉽게 사용할 수 있도록 태그로 만들어서 <br> 표준으로 제공하는
		라이브러리(클래스 모음집)<br>
	</p>
	...
	1) http://tomcat.apache.org로 접속
	<br> 2) Standard-1.2.5.jar파일 4개다 다운받기
	<br> 3) WEB-INF/lib폴더에 추가해주기
	<br>

	<h4>* JSTL 선언</h4>

	<p>
		JSTL을 사용하고자 하는 해당 JSP파일 상단에 <br> (보통 page지시어 바로 밑에) <br>
		taglib지시어를 사용해서 선언함<br> <br> [ 표현법 ]<br> &lt;@ taglib
		prefix="접두어" uri="파일uri">
	...
	<p>변수와 조건문 , 반복문 등의 로직과 관련된 태그들을 제공</p>
	...
	<c:out value="${num1 }" />
	<br> 이걸 왜 이렇게 씀? : ${num1 }
	<br> requestScope result : ${resultScope.result }
	<br> out 태그 사용 :
	<c:out value="${resultScope.result }" default="값이 없다"></c:out>
	...
	<pre>
 		...
 		- Java의 if-else문 , switch문
 		각 조건들은 choose의 하위요소로 when 태그를 이용해서 작성
