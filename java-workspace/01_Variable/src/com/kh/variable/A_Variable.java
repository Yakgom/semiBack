...
public class A_Variable  {
	...
	public void findSeasonMenu() {
		...
		System.out.println("딸기라떼를 17잔 시키셨습니다.");
	...
	public void declareVariable() {
		 ...
		 * 
		 * int a, b ,c <-- 권장하지 않음
		 * 변수를 선언하고 난 뒤 처음 값을 대입하는것을 초기화라고함(Initialization)라고함
		 ...
		 * - 메소드 식별자에 경우 식별자 뒤에 반드시 한 쌍의 "()"를 붙임
		...
		// localVariable은 초기화(Initialized)를 하지 않으면 사용할 수 없음
		isTrue = true; // 초기화
		System.out.println(isTrue);
