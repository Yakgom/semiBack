...
import com.kh.idol.movel.vo.Board;
import com.kh.idol.movel.vo.Fan;
import com.kh.idol.movel.vo.Idol;
...
public class IdolView {
	...
	private void infoMenu() {
		...
		System.out.println("5. 모든멤버 정보보기");
	...
	private void findAll() {
		...
		if (aespa.isEmpty()) {
			...
			for (Idol i : aespa) {
				...
				System.out.println();
				System.out.println("멤버 이름 : " + i.getName());
	...
	private void login() {
		...
		if (fan != null) {
			System.out.println(fan.getUserName() + "님 환영합니다");
			loginFan = fan;
		} else {
	...
	private void post() {
		...
		if(loginFan != null) {
			...
			ic.post(boardTitle,boardContent, loginFan.getUserName());
...
//			});
	...
	private void findByBoardNumber() {
