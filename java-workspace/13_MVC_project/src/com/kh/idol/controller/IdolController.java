...
public class IdolController {
	...
	public Idol findMember(int memberNo) {
		/*
		 * if(memberNo == 1) { retrun aespa.get(0) }else if(memberNo == 2) { return
		 * aespa.get(1) }else if() { return aespa.get(2) }else { return aespa.get(3) }
		 */
	...
	// 생성된 Fan 객체의 주소값을 내가 가지고 있는 Fan들이 들어가는 List의 요소로
	...
	public void post(String boardTitle,String boardContent,String userName) {
