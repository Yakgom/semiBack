...
import com.kh.movel.vo.Restaurant;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		//System.out.println(r1.infomation());
		...
		System.out.println(r0.infomation());
		System.out.println(r1.infomation());
		System.out.println(r2.infomation());
		// 1번 setter 호출
		...
		System.out.println(r.infomation());		
		System.out.println(r2.infomation());
		System.out.println(r3.infomation());
		*/
		
		// 2절
		// 사용자에게 상호명을 입력받아서
		// 만약에 입력받은 상호와 일치하는 식당의 메인메뉴를 출력해주는 프로그램
