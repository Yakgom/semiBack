...
public class Run {
	...
	public static void main(String[] args) {
		...
		System.out.println(kf.informartion());
		System.out.println(yf.informartion());
		System.out.println(jf.informartion());
		
		
		/*
		 * 매 클래스마다 중복된 코드들을 하나하나 기술하다보면
		 * 코드의 추가 또는 수정과 같은 유지보수 시 전부 한땀한땀 찾아서 고쳐야하는 번거러움이생김
		 * 
		 * 상속이라는 개념을 적용해서
