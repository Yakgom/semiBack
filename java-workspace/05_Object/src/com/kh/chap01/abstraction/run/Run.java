...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 개수 ) VO 클래스 5개 + VO관리 프로그램 5개 
		 * 각 VO클래스의 최소 필드 수 5개 
		 * 최소 한 개 이상의 필드 값을 변경할 수 있는 메소드 생성 --> Puppy클래스 bark()처럼
		 * 
		 * 
		 * 제출할 곳 : 우리반게시판 게시글 작성 
		 * 			과제 탭을 선택 할 수 있음
		...
		// 색상 : 갈색
		// 몸무게 : 3kg
		// ==> 추상화 : 많은 정보들 중 프로그램에서 필요한 정보들로 생성
		...
		System.out.println(smart.name + "는 " + smart.color + " " + smart.speciec + "입니다.");
		System.out.println(smart.age + "살 " + smart.gender + "에 " + smart.weight + "kg입니다.");

		Puppy soldier = new Puppy();

		soldier.speciec = "그레이트 피레니즈";
		soldier.name = "상근이";
		soldier.age = 22;
		soldier.gender = "수컷";
		soldier.color = "흰색";
		...
		System.out.println(soldier.name + "는 " + soldier.color + " " + soldier.speciec + "입니다.");
		System.out.println(soldier.age + "살 " + soldier.gender + "에 " + soldier.weight + "kg입니다.");
