...
public class Cafe  {
	 ...
	 * 
	 * DTO는 2달뒤에 배울건데 DTO 학습 전까지만 VO클래스에 setter를 구현해서 사용
	 * 
	 * setter 만들기 규칙
	 * 
	...
	public void setSignatureMenuPrice(int signatureMenuPrice) {
		...
		// Scope안에서는 해당 연역안에 있는 지역변수에 대한 우선권이 있음
	...
	// getter() / setter() 다만들었다 ==> 캡슐화가 끝남(문법적인 관례)
	 ...
	 public String info() {
		 ...
		 // retrun 할 때 반환할 수 있는 값 단 한개
		 String info = "[name 필드값 : " + name + ", address 필드값 : " + address +", signatureMenuPrice : " + signatureMenuPrice + "]";
		 return info;
		// System.out.println("name : " + name + " address : " + address + " signatureMenuPrice : " + signatureMenuPrice);
	 }
