...
import com.kh.chap03.movel.vo.MBTI;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		System.out.println(set); // 저장 순서 보정 X , 중복 허용 X 
		...
		Iterator<MBTI> it = mbti.iterator();
		...
		// => List 계열 Set계열은 전부다 iterator()를 호출해서 반복을 시킬 수 있음
		// => Map계열에서는 바로는 불가능
