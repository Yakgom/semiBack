...
public class A_Arithmetic {
	...
	public void test() {
		System.out.println("꼭 메인메소드에서 호출해야하는것은 아님!");
	...
	public void presentToStudent() {
		...
		System.out.println("학생 한 명당 받을 수 있는 사탕의 개수 : " + (candy / student) );
		System.out.println("남은 사탕 개수 : " + (candy % student) );
