package com.kh.chop01.run;

import com.kh.chop01.model.vo.Child1;
import com.kh.chop01.model.vo.Child2;
import com.kh.chop01.model.vo.Parent;
...
public class Run {
	 ...
	 * 
	 * 
	 * 부모클래스에게 물려받은것중에 제일 중요한것 -> 타입 ★★★★★★(자료형) 
	 * 
	 * 
	 * 
	 * 
	...
	//	p1.printParent();
		// p1.printChild1(); 자식이 가지고 있는 멤버는부모가 사용할 수 없음
	...
	//	c1.printParent(); // 부모껏도 내꺼
		// c1 변수로는 Child1 , Parent랑 둘 다 접근 가능
		...
		*/
		...
		for(int i=0; i<arr.length; i++) {
			...
			if(arr[i] instanceof Child1) {
				...
				// 현재 참조변수가 실질적으로 어떤 클래스타입을 참조하고 있는지 확일할 때 싸용
				((Child1)arr[i]).printChild1();
			}else {
				((Child2)arr[i]).printChild2();
			}*/
			 ...
			 * 
			 * 
			 * 다형성 : 부모클래스 자료형으로 여러 자식 클래스를 다루는 기술
			 * 
			 * 
			 * 
			 * */
