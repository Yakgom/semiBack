...
public class C_Switch {
	...
	public void method0() {
		...
		default: System.out.println("잘못된 층수입니다.");
	}
		 ...
		 * 
		 * 
		 * case 값n : 실행할코드 n; // 동등비교대상 == 값n true일 경우 실행할코드 n을 수행
		 * 
		 * default : 실행할코드; // == else
		 * 
		 * }
	...
	public void method1() {
		...
		case "부찌" : {
			System.out.println("부대찌개 11000원 입니다.");
			break;
		}
		case "떡갈비" : {
			System.out.println("떡갈비 13000원 입니다.");
			break;
		}
		case "제육" : {
			System.out.println("제육 7000원 입니다.");
			break;
		}
		case "칼국수" : {
			System.out.println("칼국수 8000원 입니다.");
			break;
		}
		case "수제비" : {
			System.out.println("수제비 7000원 입니다.");
			break;
		}
	...
	public void login() {
		...
		// 사용자가 로그인시 입력한 비밀번호 값과 회원가입 시 가입한 비밀번호 값이 동일하다면
		
		if(id.equals(userId) && password.equals(userPw)) {
			System.out.println("로그인 되었습니다 " + name + "님 환영합니다!");
		}
		else {
