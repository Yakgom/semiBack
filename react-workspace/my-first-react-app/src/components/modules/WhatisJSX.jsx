  ...
  return (
    <div>
      ...
      <pre>
        ...
        <strong>화면을 예쁘게 만드는것과 React는 전~~혀 연관이 없음</strong>
        <br />
...
export const WhatIsJSX = () => {
  return (
    <>
      <h2>JSX란 무엇인가?</h2>
      <pre>
        JSX(JavaScript XML) JavaScript + XML을 사용한 자바스크립트 확장문법
        <br />
        리액트 요소 만드는법 : React.createElement('h1',null,'Hello~')
        <br />
        JSX 문법으로 리액트 요소 만들기 : <h1>Hello~</h1>
        <br />
        JSX문법을 사용해서 JavaScript코드 내부에서 react의 "Element"를 생성할 수
        있음. JavaScript의 모든 기능을 이용할 수 있음 + UI를 생성할 때 React랑
        같이 쓰라고 권장함.
        <br />
        ReactElement란?
        <br />
