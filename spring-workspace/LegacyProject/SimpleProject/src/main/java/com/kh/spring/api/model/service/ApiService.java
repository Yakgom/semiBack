...
public class ApiService {
	...
	public String requestBeef() {
		...
		final String API_KEY ="87accb0e4de58f514dd664d6ec2beb1beb993812e954fa6c14d0334ceb045d8f";
	...
	public String requestBlog(String query) {
		...
		String clientId = "ea_EAEcZsXa3jr5VqwK_"; //애플리케이션 클라이언트 아이디
        String clientSecret = "EaFuUiolWE"; //애플리케이션 클라이언트 시크릿
	 ...
	 private  String get(String apiUrl, Map<String, String> requestHeaders){
	    ...
	    public String getBusanDetail(int num) {
	    	final String SERVICE_KEY ="?serviceKey=ce2dca8004788f0f0fd0c7ccafd032e98bdcfec2c32a3f4843fe96950e538dda";
